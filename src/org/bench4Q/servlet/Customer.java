...
public class Customer {
	...
	public Timestamp c_login;
	public Timestamp c_expiration;
	...
	public Customer(ResultSet rs) {
		...
		try {
			...
			c_login = rs.getTimestamp("c_login");
			c_expiration = rs.getTimestamp("c_expiration");
	...
	public String toString() {
		return "Customer [c_id=" + c_id + ", c_uname=" + c_uname
				+ ", c_passwd=" + c_passwd + ", c_fname=" + c_fname
				+ ", c_lname=" + c_lname + ", c_phone=" + c_phone
				+ ", c_email=" + c_email + ", c_since=" + c_since
				+ ", c_last_visit=" + c_last_visit + ", c_login=" + c_login
				+ ", c_expiration=" + c_expiration + ", c_discount="
				+ c_discount + ", c_balance=" + c_balance + ", c_ytd_pmt="
				+ c_ytd_pmt + ", c_birthdate=" + c_birthdate + ", c_data="
				+ c_data + ", addr_id=" + addr_id + ", addr_street1="
				+ addr_street1 + ", addr_street2=" + addr_street2
				+ ", addr_city=" + addr_city + ", addr_state=" + addr_state
				+ ", addr_zip=" + addr_zip + ", addr_co_id=" + addr_co_id
				+ ", co_name=" + co_name + "]";
	}
