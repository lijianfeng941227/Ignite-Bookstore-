...
/**
 * ShoppingCartLineKey definition.
 *
 * Code generated by Apache Ignite Schema Import utility: 09/27/2016.
 */
public class ShoppingCartLineKey implements Serializable {
    /** */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof ShoppingCartLineKey))
            return false;

        ShoppingCartLineKey that = (ShoppingCartLineKey)o;
    ...
    @Override public String toString() {
        return "ShoppingCartLineKey [sclScId=" + sclScId +
            ", sclIId=" + sclIId +
            "]";
    }
}
